...
const cardData = [
  ...
  },
  {
    ...
    description:
      "A collective of smallholder farmers working together to enhance production, share resources, and access better markets.",
    district: "Kota",
    state: "Rajasthan",
    pincode: "324001",
  ...
  },
  {
    ...
    description:
      "Promoting eco-friendly farming practices and helping farmers transition to sustainable methods to preserve the environment.",
    district: "Nagpur",
    state: "Maharashtra",
    pincode: "440001",
  ...
  },
  {
    ...
    description:
      "Empowering women farmers with resources, training, and support to foster their growth and contribution to agriculture.",
    district: "Lucknow",
    state: "Uttar Pradesh",
    pincode: "226001",
  ...
  },
  {
    ...
    description:
      "Connecting young and aspiring farmers to share knowledge, innovations, and opportunities to drive the future of agriculture.",
    district: "Patna",
    state: "Bihar",
    pincode: "800001",
  ...
  },
  {
    ...
    description:
      "A community promoting agroecology principles, emphasizing biodiversity, soil health, and sustainable farming techniques.",
    district: "Kolkata",
    state: "West Bengal",
    pincode: "700001",
  ...
  },
  {
    ...
    description:
      "Helping farmers adopt modern smart farming tools and technologies to increase efficiency and productivity.",
    district: "Hyderabad",
    state: "Telangana",
    pincode: "500001",
  ...
  },
  {
    ...
    description:
      "Uniting farmers in their efforts to address climate change through mitigation and adaptation strategies in agriculture.",
    district: "Chandigarh",
    state: "Punjab",
    pincode: "160001",
  ...
  },
  {
    ...
    description:
      "Fostering organic farming and sustainable agriculture through collective efforts to reduce environmental impact.",
    district: "Chennai",
    state: "Tamil Nadu",
    pincode: "600001",
  ...
  },
  {
    ...
    description:
      "Promoting farming practices that support biodiversity, sustainable ecosystems, and resilient agricultural landscapes.",
    district: "Pune",
    state: "Maharashtra",
    pincode: "411001",
  ...
  },
  {
    ...
    description:
      "Providing farmers with access to resources, training, and advocacy to empower them in sustainable farming practices.",
    district: "Guwahati",
    state: "Assam",
    pincode: "781001",
  ...
  },
  {
    ...
    description:
      "A group of farmers and organizations focused on improving rural communities through sustainable agriculture and social development.",
    district: "Bhopal",
    state: "Madhya Pradesh",
    pincode: "462001",
  ...
  },
  {
    ...
    description:
      "Supporting research-driven farming techniques and innovations to improve productivity and sustainability.",
  ...
  },
  {
    ...
    description:
      "Providing educational resources and training to farmers on modern farming techniques and sustainable agriculture.",
    district: "Ahmedabad",
    state: "Gujarat",
    pincode: "380001",
  ...
  },
  {
    ...
    description:
      "Supporting urban farmers with resources and networks to foster local food production in urban environments.",
    district: "Mumbai",
    state: "Maharashtra",
    pincode: "400001",
  ...
  },
  {
    ...
    description:
      "Bringing together organic food producers to share knowledge, techniques, and markets for sustainable food systems.",
    district: "Jaipur",
    state: "Rajasthan",
    pincode: "302001",
  ...
  },
  {
    ...
    description:
      "A network of family-owned farms working together to share resources and enhance sustainable family farming practices.",
    district: "Bengaluru",
    state: "Karnataka",
    pincode: "560001",
  ...
  },
  {
    ...
    description:
      "Supporting local farmers markets by providing resources and advocacy for smallholder farmers to sell their produce directly to consumers.",
    district: "Surat",
    state: "Gujarat",
    pincode: "395001",
  ...
  },
  {
    ...
    description:
      "Helping farmers achieve sustainable livelihoods through diversified farming practices and market access.",
  ...
  },
  {
    ...
    description:
      "A collective of organic farmers in Punjab focused on promoting sustainable farming practices and organic agriculture.",
    district: "Ludhiana",
    state: "Punjab",
    pincode: "141001",
  ...
  },
  {
    ...
    description:
      "A cooperative network in Punjab that helps farmers pool resources, share knowledge, and gain better access to markets.",
    district: "Amritsar",
    state: "Punjab",
    pincode: "143001",
  ...
  },
  {
    ...
    description:
      "Supporting sustainable agriculture practices in Punjab to preserve the environment while increasing productivity.",
    district: "Jalandhar",
    state: "Punjab",
    pincode: "144001",
  ...
  },
  {
    ...
    description:
      "A research-oriented group focusing on innovative farming techniques and improving agricultural output in Punjab.",
    district: "Patiala",
    state: "Punjab",
    pincode: "147001",
  ...
  },
  {
    ...
    description:
      "A network of farmers in Punjab working on strategies to mitigate the impact of climate change on agriculture.",
    district: "Chandigarh",
    state: "Punjab",
    pincode: "160001",
  ...
  },
  {
    ...
    description:
      "Advocating for the rights of farmers across Uttar Pradesh, providing resources and support to improve livelihoods.",
    district: "Varanasi",
    state: "Uttar Pradesh",
    pincode: "221001",
  ...
  },
  {
    ...
    description:
      "Promoting organic farming practices throughout Uttar Pradesh for healthier crops and sustainable farming.",
    district: "Lucknow",
    state: "Uttar Pradesh",
    pincode: "226001",
  ...
  },
  {
    ...
    description:
      "A cooperative network for farmers in Uttar Pradesh to share resources, techniques, and market access.",
    district: "Agra",
    state: "Uttar Pradesh",
    pincode: "282001",
  ...
  },
  {
    ...
    description:
      "Supporting sustainable farming practices and eco-friendly techniques to improve agricultural output in Uttar Pradesh.",
    district: "Kanpur",
    state: "Uttar Pradesh",
    pincode: "208001",
  ...
  },
  {
    ...
    description:
      "Providing education, resources, and advocacy to empower farmers throughout Uttar Pradesh.",
    district: "Meerut",
    state: "Uttar Pradesh",
    pincode: "250001",
    ...
    <section className="h-full min-h-[90vh] px-28 bg-[#f4d8bf] pt-[5vw]">
      ...
      <div className="flex flex-wrap gap-8 ml-7 mt-5">
        {filteredData.map((data, index) => (
          <Card
            key={index}
            className=" w-96 mb-8 py-10 bg-[#cb8f56] bg-opacity-35 backdrop-blur-md rounded-lg shadow-lg shadow-[#cb8f56] transition-transform transform hover:scale-105 hover:shadow-xl hover:bg-[#c08854] hover:bg-opacity-30"
          >
            <Link href="/community/National Farmers Union">
              <CardHeader>
                <h2 id="small-cards-title">
              ...
              <CardContent>
                <div className="flex flex-col justify-center items-center text-center font-bold">
                  <div className="border-t border-gray-700 w-full my-2"></div>
                  <h3 className="text-lg font-semibold text-[#a06e4c]">
                    Location
                  </h3>
                  <div className="border-t border-gray-700 w-full my-2"></div>
                  <p>
                    District:
                    <span className="text-sm text-[#a06e4c]">
                      {" "}
                      {data.district}
                    </span>
                  </p>
                  <p>
                    State:{" "}
                    <span className="text-sm text-[#a06e4c]">{data.state}</span>
                  </p>
                  <p>
                    Pincode:
                    <span className="text-sm text-[#a06e4c]">
