    ...
    <div className="flex justify-center p-10 max-w-[50]">
      <PdfGenerator name={data.name}>
        <section className="mx-auto space-y-5 font-medium my-auto text-xs max-w-[80vw] ">
                ...
                <span className="font-medium underline underline-offset-4">
                  {Math.floor(
                    new Date().getFullYear() -
                      new Date(value.Farmer!.date_of_birth!).getFullYear(),
                  )}{" "}
                  years
                </span>
                ,
          ...
          <p>
            AND WHEREAS the Farmer is owning and/or in possession of
            agricultural land suitable for growing the crops required by the
            Company for export and accordingly is desirous of entering into an
            agreement with the Company for growing the said crop as per the
            specification, terms and conditions that are stipulated by the
            Company including selling of 100% of the crop produced by the farmer
            to the Company on mutually acceptable terms and conditions and
            accordingly this agreement is entered into between the parties. AND
            WHEREAS the farmer herein after understanding the requirements of
            the Company and their terms and requirements has agreed to the terms
            set out and has agreed to comply with the same. The parties have
            consequently reduced into writing the terms and conditions as
            details hereinafter.
          </p>
          <div>
          ...
          <p>
            IN WITTNESS WHEREOF both the parties have affixed their
            seal/signature on the day........ month................. and the
            year............ in the presence of following witnesses.
          </p>
